...
function createEventListeners() { 
    var deliveryMonth = document.getElementById("delivMo"); 
    if (deliveryMonth.addEventListener) deliveryMonth.addEventListener("change", updateDays, false); 
    else if (deliveryMonth.attachEvent)  deliveryMonth.attachEvent("onchange", updateDays); 
